...
%% Set up data for tonal nonmusicians

subject_list = {'PP38','PP39','PP45','PP46','PP51','PP54','PP55','PP57',...
    'PP60','PP63','PP65','PP66','PP69'};

numsubjects  = length(subject_list); % number of subjects

parentfolder = 'C:\Users\Annette\Desktop\Data\Annette\TonalNonmusician\';  
...
%     eeglab redraw;
    ...
    ERP = pop_savemyerp(ERP, 'erpname', subject, 'filename', [subject '.erp'], 'filepath', ...
        'C:\Users\Annette\Desktop\Dataset\TNM_New', 'Warning', 'on');
    [ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
    % save artifact rejection summary
    EEG = pop_summary_AR_eeg_detection(EEG, ['C:\Users\Annette\Desktop\Dataset\TNM_New\AR_summary_' subject '.txt']);
    % update GUI
%   % eeglab redraw;
