...
%% Set up data for nontonal nonmusicians

subject_list = {'PP7','PP15','PP21','PP23','PP24','PP25','PP28','PP29',...
    'PP32','PP33','PP43','PP44','PP53','PP58','PP67'};

numsubjects  = length(subject_list); % number of subjects

parentfolder = 'C:\Users\Annette\Desktop\Data\Annette\NontonalNonmusician\';  
...
%     eeglab redraw;
    ...
    ERP = pop_savemyerp(ERP, 'erpname', subject, 'filename', [subject '.erp'], 'filepath', ...
        'C:\Users\Annette\Desktop\Dataset\NTNM_New', 'Warning', 'on');
    [ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
    % save artifact rejection summary
    EEG = pop_summary_AR_eeg_detection(EEG, ['C:\Users\Annette\Desktop\Dataset\NTNM_New\AR_summary_' subject '.txt']);
    % update GUI
%   % eeglab redraw;
